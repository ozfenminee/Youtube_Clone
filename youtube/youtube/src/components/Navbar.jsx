  ...
  return (
    <div className='w-full flex items-center justify-between h-20 px-3'>
      <div className='w-3/12 flex items-center space-x-4'>
        <icons.menu className=' icon-style text-2xl'/>
      ...
      <div className='w-6/12 flex items-center space-x-4'>
        <div className='w-3/4 flex items-center'>
          <input onKeyUp={onKeyFunc} value={searchKeyword} onChange={e=>setSearchKeyword(e.target.value)} className=' outline-none border p-2 h-10 flex-1' type="text" placeholder='Ara' />
          <div onClick={searchFunc} className='bg-gray-100 h-10 w-20 flex items-center justify-center border'> 
            <icons.search className=' icon-style text-2xl'/>
          </div>
          <div className='w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center cursor-pointer ml-4'>
            <icons.microphone className=' icon-style text-2xl'/>
          </div>
        </div>
      </div>
